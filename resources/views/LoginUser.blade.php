  ...
  <body background="{{ asset('img/page-background.png') }}">
    ...
    <div class="container">
      ...
      <form class="form-signin" action="{{ url('auth/login') }}" method="post">
        ...
        <center><h2 class="form-signin-heading"><span class="glyphicon glyphicon-th-large"></span> <font size="+5">/P</font>usWeb<font size="-2">.com</font></h2></center>
      ...
      <div class="alert alert-info form-signin">
        <a href="" class="close" data-dismiss="alert" aria-label="close">&times;</a>
        <strong><i class=" glyphicon glyphicon-info-sign"></i> Info!</strong><br>Username : Nama Anda<br>Password : Nama Anda + Tanggal Lahir<br><br><strong>Contoh :</strong><br>Username : didik<br>Password : didik19970821
      </div>
