...
<head>
    ...
    <!-- Morris chart -->
    <link href="{{ asset('css/css/morris.css') }}" rel="stylesheet" type="text/css" />
    <!-- jvectormap -->
    <link href="{{ asset('css/css/jquery-jvectormap-1.2.2.css') }}" rel="stylesheet" type="text/css" />
    <!-- Date Picker -->
    <link href="{{ asset('css/css/datepicker3.css') }}" rel="stylesheet" type="text/css" />
    <!-- fullCalendar -->
    <!-- <link href="css/fullcalendar/fullcalendar.css" rel="stylesheet" type="text/css" /> -->
    <!-- Daterange picker -->
    <link href="{{ asset('css/css/daterangepicker-bs3.css') }}" rel="stylesheet" type="text/css" />
                ...
                <div class="navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="{{ url('auth/login') }}" data-placement="bottom" data-toggle="tooltip" title="Login Admin">
